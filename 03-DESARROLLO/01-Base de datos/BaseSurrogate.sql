...
CREATE TABLE user_rol (
    ...
    CONSTRAINT pk_user_rol PRIMARY KEY (rol_name,id_user),
...
CREATE TABLE payment (
    ...
    CONSTRAINT fk_clie_paym FOREIGN KEY (id_client) REFERENCES client(id),
...
CREATE TABLE description (
    ...
    CONSTRAINT uk_description UNIQUE (code_description)
);
...
CREATE TABLE product (
    ...
    CONSTRAINT fk_desc_prod FOREIGN KEY (id_description) REFERENCES description(id),
...
CREATE TABLE order_details (
    ...
    CONSTRAINT uk_order_details UNIQUE (id_client,id_product,total_value),
    CONSTRAINT fk_clie_orde_deta FOREIGN KEY (id_client) REFERENCES client(id),
...
CREATE TABLE order_ (
    ...
    CONSTRAINT uk_order UNIQUE (id_order_details,id_payment,id_client),
    CONSTRAINT fk_orde_deta_orde FOREIGN KEY (id_order_details) REFERENCES order_details(id),
    CONSTRAINT fk_paym_orde FOREIGN KEY (id_payment) REFERENCES payment(id),
