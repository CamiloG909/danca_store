...
INSERT INTO user_rol VALUES
    ('Cliente','cgalindorivera@gmail.com'),
    ('Cliente','andresgom35@gmail.com'),
    ('Cliente','johitan563@gmail.com'),
    ('Cliente','jaimeaguayogo7895@gmail.com'),
    ('Cliente','andrehere89@gmail.com'),
    ('Cliente','ruth877_2021@gmail.com'),
    ('Cliente','arijesusram1_7@gmail.com'),
    ('Cliente','feliram74-89@gmail.com'),
    ('Cliente','hansel-845@gmail.com'),
    ('Cliente','aniyensysarai_flores@gmail.com'),
    ('Cliente','karlapual212@gmail.com'),
    ('Cliente','darksusp21@gmail.com'),
    ('Vendedor','sntninco@gmail.com')
;

--client
INSERT INTO client (document_number,name,last_name,initials,login) VALUES 
    ('10130960','Camilo','Rivera Posada','CC','cgalindorivera@gmail.com'),
    ('65717987','Andrés','Gomez Gomez','CC','andresgom35@gmail.com'),
    ('98456256','Johan Andrés','Bautista','CC','johitan563@gmail.com'),
    ('101233843','Jaime Francisco','Aguayo González','CC','jaimeaguayogo7895@gmail.com'),
    ('53008488','Andrea','Chávez Heredia','CC','andrehere89@gmail.com'),
    ('32128429','Ruth Silvana','Cortés Lagunes','CC','ruth877_2021@gmail.com'),
    ('91263812','Ariana','de Jesús Ramos','CC','arijesusram1_7@gmail.com'),
...
--supplier
INSERT INTO supplier (company_name,phone_number,address,email,postal_code,status) VALUES
    ('Xiaomi','3154319637','Cl. 8 Sur ##7184, Bogotá','xiaomi@gmail.com','115648','Activo'),
    ('Motorola Inc.','3138622497','Cl. 38 A sur #34D – 51, Bogotá','motorola@gmail.com','879456','Activo'),
    ('Acer Inc.','3149874587','Cl. 73 #40, Bogotá','acer@gmail.com','564654','Activo'),
    ('ASUS','3165479931','Cra. 16 ###76-42 Oficina 204, Bogotá','asus@gmail.com','879512','Activo'),
    ('Hewlett-Packard Development Company, L.P','3204568713','Cr. 7 No 99-, Bogotá','hpcompany@gmail.com','110432','Activo')
;

--payment
INSERT INTO payment (method_payment,bill_date,initials,document_number,status) VALUES
    ('Efectivo','2021-01-08 10:32:50','CC','10130960','Completo'),
    ('Tarjeta de Débito','2021-02-15 17:05:06','CC','65717987','Completo'),
    ('Tarjeta de Crédito','2021-02-20 12:10:25','CC','98456256','Completo'),
    ('Tarjeta de Crédito','2021-03-27 08:09:18','CC','101233843','Completo'),
    ('Tarjeta de Débito','2021-04-12 13:01:01','CC','91263812','Completo'),
    ('Tarjeta de Débito','2021-05-04 17:00:00','CC','95752599','Cancelado')
;
...
--description
INSERT INTO description (code,specs,information,condition,color) VALUES
    ('84654',
    ...
    'Nuevo','Negro espacial, Azul neptuno, Luz de luna'),
    ('48213','Memoria Interna: 128 GB Memoria RAM: 4 GB Procesador: Qualcomm 8 Núcleos Sistema Operativo: Android 11 Cámara Frontal: Sencilla 13 Mpx Cámara Posterior: Cuadruple 64  Mpx 8 MPX + 2MPX + 2MPX',
    ...
    'Nuevo','Morado, Negro'),
    ('232181','Memoria RAM: 8 GB Almacenamiento: Disco Estado Solido (SSD) 512  GB Procesador: Intel Core I5 1135G7 Pantalla: Full HD 14  Pulgadas Duración de la Batería: 8  Horas Aproximadas Opciones de Conectividad: Bluetooth, USB, WiFi',
    ...
    'Nuevo',null),
    ('56646','Memoria Interna: 128 GB Memoria RAM: 6 GB Procesador: Qualcomm 8 Nucleos Sistema Operativo: Android 10 Cámara Frontal: Sencilla 20 Mpx Cámara Posterior: Cuadruple 64 Mpx 13MPX+2MPX+2MPX',
    ...
    'Nuevo','Phantom Black, Frost Blue, Metal Bronze')
;

--product
INSERT INTO product (reference,name,price,picture,stock,category_name,code_description,company_name_supplier,status) VALUES
    ('84654','All In One ASUS Vivo AIO V222FAK-BA241T','1529000','https://i.imgur.com/2W7HRiw.jpg','12','Computadores','84654','ASUS','Disponible'),
    ('45691','Xiaomi Note 8','699900','https://i.imgur.com/FFCY4oN.jpg','24','Celulares','45691','Xiaomi','Disponible'),
    ('48213','Motorola G30','999900','https://comoto.vteximg.com.br/arquivos/ids/159108-800-800/_0005_2020_Capri-_BasicPack_PhantomBlack_Front-View.png?v=637487717947530000','14','Celulares','48213','Motorola Inc.','Disponible'),
    ('232181','Acer Porsche AP714-51t-555d','6999000','https://static.acer.com/up/Resource/Acer/Laptops/Porsche_Design_Acer_Book_RS/Images/20201012/Porsche-Design-Acer-Book-RS_AP714-51_modelmain.png','6','Computadores','232181','Acer Inc.','Disponible'),
    ('56646','Xiaomi POCO X3','1049900','https://i.imgur.com/Vc4oDpk.jpeg','9','Celulares','56646','Xiaomi','Disponible')
;

--order_details
INSERT INTO order_details (reference,document_number,initials,total_value,amount,color) VALUES
    ('45691','10130960','CC','699900','1','Luz de luna'),
    ('45691','65717987','CC','1399800','2','Azul neptuno, Negro espacial'),
    ('84654','98456256','CC','1529000','1',null),
    ('48213','101233843','CC','999900','1','Morado'),
    ('56646','91263812','CC','1049900','1','Frost Blue'),
    ('48213','95752599','CC','999900','1','Negro')
;

--order_
INSERT INTO order_ (document_number,initials,payment_number,method_payment,code_order_details,order_date,status) VALUES
    ('10130960','CC','1','Efectivo','1','2021-01-08 10:35:00','Completado'),
    ('65717987','CC','2','Tarjeta de Débito','2','2021-02-15 17:06:00','Completado'),
    ('98456256','CC','3','Tarjeta de Crédito','3','2021-02-20 12:11:00','Completado'),
    ('101233843','CC','4','Tarjeta de Crédito','4','2021-03-27 08:10:00','Completado'),
    ('91263812','CC','5','Tarjeta de Débito','5','2021-04-12 13:02:00','Completado'),
    ('95752599','CC','6','Tarjeta de Débito','6','2021-05-04 17:00:00','Cancelado')
;
