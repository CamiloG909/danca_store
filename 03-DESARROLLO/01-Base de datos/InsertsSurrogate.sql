...
INSERT INTO client (id_document_type,document_number,name,last_name,id_user) VALUES 
    ...
    ('3','346355327','Karla Paulette','García Arreguín','11'),
    ('3','87546982','Daniel','Smith Osorio','12')
;
...
--payment
INSERT INTO payment (id_client,id_method_payment,bill_date,status) VALUES
    ('1','1','2021-01-08 10:32:50','Completo'),
    ('2','3','2021-02-15 17:05:06','Completo'),
    ('3','2','2021-02-20 12:10:25','Completo'),
    ('4','2','2021-03-27 08:09:18','Completo'),
    ('7','3','2021-04-12 13:01:01','Completo'),
    ('9','3','2021-05-04 17:00:00','Cancelado')
;
...
--description
INSERT INTO description (code_description,specs,information,condition,color) VALUES
    ('84654',
...
--product
INSERT INTO product (reference,name,price,picture,stock,id_category,id_description,id_supplier,status) VALUES
    ('84654','All In One ASUS Vivo AIO V222FAK-BA241T','1529000','https://i.imgur.com/2W7HRiw.jpg','12','1','1','4','Disponible'),
    ('45691','Xiaomi Note 8','699900','https://i.imgur.com/FFCY4oN.jpg','24','2','2','1','Disponible'),
    ('48213','Motorola G30','999900','https://comoto.vteximg.com.br/arquivos/ids/159108-800-800/_0005_2020_Capri-_BasicPack_PhantomBlack_Front-View.png?v=637487717947530000','14','2','3','2','Disponible'),
    ('232181','Acer Porsche AP714-51t-555d','6999000','https://static.acer.com/up/Resource/Acer/Laptops/Porsche_Design_Acer_Book_RS/Images/20201012/Porsche-Design-Acer-Book-RS_AP714-51_modelmain.png','6','1','4','3','Disponible'),
    ('56646','Xiaomi POCO X3','1049900','https://i.imgur.com/Vc4oDpk.jpeg','9','2','5','1','Disponible')
;

--order_details
INSERT INTO order_details (id_client,id_product,total_value,amount,color) VALUES
    ('1','2','699900','1','Luz de luna'),
    ('2','2','1399800','2','Azul neptuno, Negro espacial'),
    ('3','1','1529000','1',null),
    ('4','3','999900','1','Morado'),
    ('7','5','1049900','1','Frost Blue'),
    ('9','3','999900','1','Negro')
;

--order_
INSERT INTO order_ (id_order_details,id_payment,id_client,order_date,status) VALUES
    ('1','1','1','2021-01-08 10:35:00','Completado'),
    ('2','3','2','2021-02-15 17:06:00','Completado'),
    ('3','2','3','2021-02-20 12:11:00','Completado'),
    ('4','4','4','2021-03-27 08:10:00','Completado'),
    ('5','5','7','2021-04-12 13:02:00','Completado'),
    ('6','6','9','2021-05-04 17:00:00','Cancelado')
;
